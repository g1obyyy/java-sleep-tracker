...
public class MinSessionMinutesTest {
    private MinSessionMinutes function;

    @BeforeEach
    public void setUp() {
        function = new MinSessionMinutes();
    }
    ...
    public void shouldReturnMaxMinutesSession() {
        ...
        Assertions.assertEquals(420, function.apply(sessions).getResult());
    }

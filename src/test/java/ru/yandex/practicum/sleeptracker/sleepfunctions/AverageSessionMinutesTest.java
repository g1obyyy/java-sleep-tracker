...
public class AverageSessionMinutesTest {
    private AverageSessionMinutes function;

    @BeforeEach
    public void setUp() {
        function = new AverageSessionMinutes();
    }
    ...
    public void shouldReturnMaxMinutesSession() {
        ...
        Assertions.assertEquals(480, function.apply(sessions).getResult());
    }
